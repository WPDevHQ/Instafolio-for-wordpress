	...
	<body class="olawale-instameta">
		...
		<?php
			...
			*/
			...
			?>
		<div style="background-image:url(<?php echo $thumb; ?>);" class="insta-featured gridded">
		...
		<div class="insta_sub_body">
			<div class="insta-pics">
				<div class="olawale-insta-meta-parent col-sm-6 gridded olawale-insta-meta-parent-sze-one">
				...
				<div data-url="<?php echo $insta_post->link; ?>" class="insta-element gridded">
					<!--instapic-->
			...
			<div class="insta_load_more">
				<div data-nexturl="<?php echo $result->pagination->next_url; ?>" class="load_more_grams load_more_grams_normal">LOAD MORE</div>
			</div>
		</div>
		<?php
			footer:
