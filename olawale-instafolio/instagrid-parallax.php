...
<html <?php language_attributes(); ?>>
	...
	<body class="olawale-instameta instagrid-fullwidth instagrid-fullwidth-parallax">
		...
		<div class="insta_sub_body">
			...
			<div class="insta_load_more">
				<div data-nexturl="<?php echo $result->pagination->next_url; ?>" class="load_more_grams load_more_grams_parallax_fw">LOAD MORE</div>
			</div>
		</div>
		<?php
			footer:
